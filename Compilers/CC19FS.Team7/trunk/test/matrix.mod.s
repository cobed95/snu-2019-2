...
l_minit_3_while_body:
    ...
    movl    %eax, -60(%ebp)        
l_minit_7_while_cond:
    movl    -60(%ebp), %eax         #   7:     if     x < 8 goto 8_while_body
    movl    $8, %ebx               
    cmpl    %ebx, %eax             
    jl      l_minit_8_while_body   
    jmp     l_minit_6               #   8:     goto   6
l_minit_8_while_body:
    ...
    movl    %eax, -56(%ebp)        
    movl    -56(%ebp), %eax         #  23:     if     v = 10 goto 13_if_true
    movl    $10, %ebx              
    cmpl    %ebx, %eax             
    je      l_minit_13_if_true     
    jmp     l_minit_14_if_false     #  24:     goto   14_if_false
l_minit_13_if_true:
    movl    $0, %eax                #  26:     assign v <- 0
    movl    %eax, -56(%ebp)        
    jmp     l_minit_12              #  27:     goto   12
l_minit_14_if_false:
l_minit_12:
    ...
    movl    %eax, -60(%ebp)        
    jmp     l_minit_7_while_cond    #  32:     goto   7_while_cond
l_minit_6:
...
l_madd_3_while_body:
    ...
    movl    %eax, -112(%ebp)       
l_madd_7_while_cond:
    movl    -112(%ebp), %eax        #   7:     if     x < 8 goto 8_while_body
    movl    $8, %ebx               
    cmpl    %ebx, %eax             
    jl      l_madd_8_while_body    
    jmp     l_madd_6                #   8:     goto   6
l_madd_8_while_body:
    movl    $2, %eax                #  10:     param  1 <- 2
    pushl   %eax                   
    ...
    movl    %eax, -112(%ebp)       
    jmp     l_madd_7_while_cond     #  44:     goto   7_while_cond
l_madd_6:
...
l_mprint_11_while_body:
    ...
    movl    %eax, -96(%ebp)        
l_mprint_18_while_cond:
    movl    -96(%ebp), %eax         #  37:     if     x < N goto 19_while_body
    movl    -20(%ebp), %ebx        
    cmpl    %ebx, %eax             
    jl      l_mprint_19_while_body 
    jmp     l_mprint_17             #  38:     goto   17
l_mprint_19_while_body:
    ...
    movl    %eax, -96(%ebp)        
    jmp     l_mprint_18_while_cond  #  57:     goto   18_while_cond
l_mprint_17:
